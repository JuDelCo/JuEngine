...
#define IM_VEC2_CLASS_EXTRA                                                 \
        ImVec2(const JuEngine::vec2& f) { x = f.x; y = f.y; }                       \
        operator JuEngine::vec2() const { return JuEngine::vec2(x,y); }

#define IM_VEC4_CLASS_EXTRA                                                 \
        ImVec4(const JuEngine::vec4& f) { x = f.x; y = f.y; z = f.z; w = f.w; }     \
        operator JuEngine::vec4() const { return JuEngine::vec4(x,y,z,w); }
